...
import background from "./svgBack"
...
function App() {
  ...
  return (
    ...
    <div className="background -z-10">
                      ...
                      <svg width="30" height="30" viewBox="0 0 126 126" fill="" xmlns="http://www.w3.org/2000/svg" className='absolute bottom-36 right-12 max-md:bottom-48 max-md:right-16'>
                            <defs>  
                              <linearGradient id="logo-gradient" x1="0%" y1="0%" x2="100%" y2="0%" > 
                                  <stop offset="0%" stopColor="#f7a5fc">
                                      <animate attributeName="stop-color" values="#f7a5fc; #e7acdd; #FB99EF" dur="4s" repeatCount="indefinite"></animate>
                                  </stop>

                                  <stop offset="50%" stopColor="#f992ff">
                                      <animate attributeName="stop-color" values="#f992ff; #e7acdd; #f992ff" dur="4s" repeatCount="indefinite"></animate>
                                  </stop>

                                  <stop offset="100%" stopColor="#e7acdd">
                                      <animate attributeName="stop-color" values="#e7acdd; #f8b4ff; #e7acdd" dur="4s" repeatCount="indefinite"></animate>
                                  </stop>
                              </linearGradient> 
                          </defs>
      ...
      <p className=' text-lg mt-2 mb-2 h-full max-md:text-2xl max-s:w-80 max-sm:w-96 max-md:mt-4 max-md:mb-4 text-center tracking-widest'>{girl.additional_info?.replace("{geo}", girl.geo)}</p>
